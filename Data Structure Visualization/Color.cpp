...
HASH::Color HASH::colorTypeTransition(colorType colorBefore, colorType colorAfter, colorTheme theme, float percent)
{
	return HASH::Color(
		colorTransition(HASH::color[theme][colorBefore].fillColor, HASH::color[theme][colorAfter].fillColor, percent),
		colorTransition(HASH::color[theme][colorBefore].outlineColor, HASH::color[theme][colorAfter].outlineColor, percent),
		colorTransition(HASH::color[theme][colorBefore].valueColor, HASH::color[theme][colorAfter].valueColor, percent),
		colorTransition(HASH::color[theme][colorBefore].variableColor, HASH::color[theme][colorAfter].variableColor, percent)
	);
}
